...
namespace PHPSTORM_META {
    ...
    override(
        \Phalcon\Di\DiInterface::getShared(0),
        map([
            "cache" => Adapter::class,
            "instance" => \Instance::class,
        ])
    ...
    override(
        \Phalcon\Di\DiInterface::get("cache"),
        map([
            "cache" => Adapter::class,
        ])
    );
    override(
        \Phalcon\Di\DiInterface::getShared("cache"),
        map([
            "cache" => Adapter::class,
        ])
    );
